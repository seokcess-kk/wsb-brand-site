...
import {
  BusinessPillarVisual,
  type PillarVariant,
} from "@/components/visual/business-pillar-visual";
...
function PillarCard({ pillar, index }: { pillar: Pillar; index: number }) {
  const variant = (PILLAR_TOPICS[index] ?? "material") as PillarVariant;
  return (
    <MotionCard as="article" className="flex h-full flex-col">
      {/* Instrument-panel visual, full-bleed at the card head */}
      <BusinessPillarVisual variant={variant} />

      <div className="flex flex-1 flex-col gap-7 p-8 md:p-10">
        {/* Header */}
