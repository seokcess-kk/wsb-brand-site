    ...
    <>
      ...
      <section className="bg-canvas border-t border-structural/10">
        <div className="mx-auto max-w-7xl px-6 py-24 md:py-32">
          ...
          <div className="grid gap-px bg-structural/10 md:grid-cols-2">
            {research.map((r, i) => (
              <RevealOnView key={r.title} delay={0.08 * i} className="h-full">
                <article className="flex h-full flex-col gap-3 bg-canvas p-6 md:p-8">
      ...
      <section className="bg-canvas border-t border-structural/10">
        <div className="mx-auto max-w-7xl px-6 py-24 md:py-32">
          ...
          <div className="grid gap-px bg-structural/10 md:grid-cols-3">
            {certs.map((c, i) => (
              <RevealOnView key={c.name} delay={0.06 * i} className="h-full">
                <article className="flex h-full flex-col gap-5 bg-canvas p-6 md:p-8">
                  <div className="relative aspect-[4/3] overflow-hidden bg-structural/[0.04]">
      ...
      <section className="bg-structural text-canvas border-t border-canvas/10">
        <div className="mx-auto max-w-7xl px-6 py-24 md:py-32">
          ...
          <div className="grid gap-px bg-canvas/10">
            {national.map((p, i) => (
              <RevealOnView key={p.name} delay={0.08 * i}>
                <article className="grid gap-6 bg-structural p-6 md:grid-cols-[1.4fr_1fr_140px_120px] md:p-8 md:items-center">
